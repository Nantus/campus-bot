...
class IsFirstPilotKeyboardReplies(Enum):
    Yes = "Так"
    No = "Ні"


class IsFirstPilotKeyboard(ReplyKeyboardBuilder): 
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.button(text=IsFirstPilotKeyboardReplies.Yes.value)
        self.button(text=IsFirstPilotKeyboardReplies.No.value)
