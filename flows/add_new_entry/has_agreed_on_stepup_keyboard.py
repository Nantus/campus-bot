...
class HasAgreedOnStepupReplies(Enum):
    Yes = "Так"
    No = "Ні"


class HasAgreedOnStepupKeyboard(ReplyKeyboardBuilder): 
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.button(text=HasAgreedOnStepupReplies.Yes.value)
        self.button(text=HasAgreedOnStepupReplies.No.value)
