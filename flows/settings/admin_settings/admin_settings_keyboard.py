...
class AdminSettingsKeyboardReplies(Enum):
    BroadcastToAll = "Надіслати повідомлення всім користувачам бота"


class AdminSettingsKeyboard(ReplyKeyboardBuilder): 
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.button(text=AdminSettingsKeyboardReplies.BroadcastToAll.value)
